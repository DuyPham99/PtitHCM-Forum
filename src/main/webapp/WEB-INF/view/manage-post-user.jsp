                        ...
                        <header>
                            <div class="container-fluid bg-white">
                                <div class="row text-center border-bottom">
                                    ...
                                    <div class="col-6">
                                        <a href="#"><i class="fa fa-search"></i></a> <input class="header-search"
                                            size="40" type="text" placeholder="Tìm kiếm bài viết, tác giả,..."
                                            aria-label="Search">
                                    </div>
                                    <div class="col align-self-center" style=" z-index: 1030;">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="/logout" onclick="clearCookies()">Đăng
                                                xuất</a>
                                        </div>
                                    </div>
                                </div>
