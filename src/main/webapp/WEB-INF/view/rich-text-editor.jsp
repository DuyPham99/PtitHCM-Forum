...
<body style="background: #f2f2f2;">
		...
		<div class="container-fluid bg-white">
			<div class="row text-center border-bottom">
				<div class="col text-right">
					<a href="#"><img src="../resource/pictures/ptitLogo.jpg"
						height="70" class="logo" width="270" style="width: 30%;"></a>
				</div>
				...
				<div class="col align-self-center">
					<a href="#" class="text-header"> Đăng ký </a> <a href="#"
	...
	<nav
		class="navbar navbar-expand-sm navbar-dark sticky-top bg-white header p-auto">
		<div class="container">
