                                ...
                                <div class="col align-self-center" style=" z-index: 1030;">
                                    <button type="text" class="dropdown" data-toggle="dropdown"
                                        ...
                                        <a href="#"> <img
                                            ...
                                            <a href="#"
                                                style="color: black; text-decoration: none;">${sessionScope["username"]}</a>
                                        </a>
                                    </button>
                                            ...
                                            <div class="position-relative border new-feed"
                                                ...
                                                <div class="toolbar">
                                                    <div class="" style="float: left;">
                                                        <i onclick="myFunction(this)" class="fas fa-heart"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
