    ...
    <div class="container-fluid bg-white">
      <div class="row text-center border-bottom">
        <div class="col text-right">
          <a href="#"><img src="../resource/pictures/ptitLogo.jpg" height="70" class="logo" width="270"
              style="width: 30%;"></a>
        </div>
              ...
              <div class="position-relative border new-feed">
                <div class="author-feed">
                  <div class="account">
                    ...
                    <a href="#" style="float:left;"><b>Author</b>&nbsp</a>
                    <p style="display: inline; color: #99A3AD;">trong</p>
                    <a href="#" class="topic-title" style="color:#2C3E50;">Học tập</a>
                    <p style="margin-bottom: 0px; color: #828b94;">time</p>
                  </div>
                </div>
                ...
                <div class="content">
                  <div class="text">
                    <!--Start:Title-->
                    <h5 class="title">
                      <a href="#" style="color: #2C3E50;"> Chủ nghĩa cộng sản </a>
                    </h5>
                    <!--End:Title-->
                    <a href="" class="body">
                      <h6 style="color: #293847;">Bài viết gốc đã được đăng tải vào 8/9/20 tại Đây . Hãy like page Ăn
                        sách nếu có thể để thể hiện sự ủng hộ cho tác giả, cám ơn các bạn. Sự tôn thờ thanh xuân và tuổi
                        trẻ ở Việt Nam...</h6>
                    </a>
                    <!--Start:author-->
                    <a href="#">
